...
export const ScreenAusente = ({ route }) => {
  const { selectedDiente } = route.params;
  console.log("Diente seleccionado en ScreenPresente: ", selectedDiente);
  const navigation = useNavigation();
  const [periodontal, setPeriodontal] = useState("Sí");
  const [otra, setOtra] = useState("Sí");
  ...
  const handleGuardarDatos = () => {
    ...
    console.log("Perdida de inserción: ", otra);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.characteristicsContainer}>
        <Text style={styles.label}>Periodontal</Text>
        <View style={styles.optionContainer}>
          <Text style={styles.optionText}>Sí</Text>
          <TouchableOpacity
            style={[styles.radioButton, periodontal === "Sí" && styles.selected]}
            onPress={() => setPeriodontal("Sí")}
          />
          <Text style={styles.optionText}>No</Text>
          <TouchableOpacity
            style={[styles.radioButton, periodontal === "No" && styles.selected]}
            onPress={() => setPeriodontal("No")}
          />
        </View>
      </View>
      ...
      <View style={styles.characteristicsContainer}>
        <Text style={styles.label}>Otra</Text>
        <View style={styles.optionContainer}>
          <Text style={styles.optionText}>Sí</Text>
          <TouchableOpacity
            style={[
              styles.radioButton,
              otra === "Sí" && styles.selected,
            ]}
            onPress={() => setOtra("Sí")}
          />
          <Text style={styles.optionText}>No</Text>
      ...
      <View style={styles.characteristicsContainer}>
        <TextInput
          ...
          multiline
          numberOfLines={4}
          placeholder="Describe el motivo por la ausencia del diente"
          value={comentarios}
